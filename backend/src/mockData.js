...
export const cards = [
  ...
  },
  {
    ...
    source: 'mydata',         // 마이데이터로 조회
    billingDay: 15,           // 매월 15일 결제
  },
]
...
export let transactions = [
  ...
  { id: 't003', date: d(5),  amount: -485000,  category: '카드대금', counterpart: '신한카드 3월 대금', accountId: 'acc001', source: 'account' },
  ...
  { id: 't032', date: d(33), amount: -462000,  category: '카드대금', counterpart: '신한카드 2월 대금', accountId: 'acc001', source: 'account' },
  ...
  { id: 't062', date: d(64), amount: -511000,  category: '카드대금', counterpart: '신한카드 1월 대금', accountId: 'acc001', source: 'account' },
  ...
  { id: 't092', date: d(94),  amount: -538000, category: '카드대금', counterpart: '신한카드 12월 대금', accountId: 'acc001', source: 'account' },
  ...
  { id: 't122', date: d(124), amount: -492000, category: '카드대금', counterpart: '신한카드 11월 대금', accountId: 'acc001', source: 'account' },
  ...
  { id: 't152', date: d(155), amount: -445000, category: '카드대금', counterpart: '신한카드 10월 대금', accountId: 'acc001', source: 'account' },
...
export let cardTransactions = [
  ...
  { id: 'ct034', ...cd(1,10,30),  cardId: 'card002', merchant: '애플 앱스토어',       inferredCategory: '구독',  categoryNote: '앱·구독 혼재',               amount: -9900  },
  { id: 'ct035', ...cd(2,14,0),   cardId: 'card002', merchant: '넷플릭스',            inferredCategory: '구독',  categoryNote: null,                         amount: -13900 },
  { id: 'ct036', ...cd(5,10,0),   cardId: 'card002', merchant: '유튜브 프리미엄',     inferredCategory: '구독',  categoryNote: null,                         amount: -14900 },
  { id: 'ct037', ...cd(8,18,30),  cardId: 'card002', merchant: '쿠팡이츠',            inferredCategory: '식비',  categoryNote: '음식 배달 (메뉴 불명)',       amount: -19500 },
  { id: 'ct038', ...cd(11,20,0),  cardId: 'card002', merchant: '지그재그',            inferredCategory: '쇼핑',  categoryNote: null,                         amount: -85000 },
  { id: 'ct039', ...cd(14,12,0),  cardId: 'card002', merchant: '마켓컬리',            inferredCategory: '식비',  categoryNote: '식품·생활용품 혼재',         amount: -67000 },
  { id: 'ct040', ...cd(17,9,30),  cardId: 'card002', merchant: 'GS주유소',            inferredCategory: '교통',  categoryNote: null,                         amount: -60000 },
  { id: 'ct041', ...cd(19,14,0),  cardId: 'card002', merchant: '스포티파이',          inferredCategory: '구독',  categoryNote: null,                         amount: -10900 },
  { id: 'ct042', ...cd(22,11,0),  cardId: 'card002', merchant: '쿠팡',                inferredCategory: '쇼핑',  categoryNote: '품목 불명 (온라인 종합몰)',   amount: -125000},
  ...
  // 2월 — 신한카드
  { id: 'ct080', ...cd(25,10,0),  cardId: 'card002', merchant: '넷플릭스',            inferredCategory: '구독',  categoryNote: null,                         amount: -13900 },
  { id: 'ct081', ...cd(26,10,0),  cardId: 'card002', merchant: '유튜브 프리미엄',     inferredCategory: '구독',  categoryNote: null,                         amount: -14900 },
  { id: 'ct082', ...cd(28,18,30), cardId: 'card002', merchant: '쿠팡이츠',            inferredCategory: '식비',  categoryNote: '음식 배달 (메뉴 불명)',       amount: -24000 },
  { id: 'ct083', ...cd(31,14,0),  cardId: 'card002', merchant: '마켓컬리',            inferredCategory: '식비',  categoryNote: '식품·생활용품 혼재',         amount: -55000 },
  { id: 'ct084', ...cd(34,9,30),  cardId: 'card002', merchant: 'GS주유소',            inferredCategory: '교통',  categoryNote: null,                         amount: -60000 },
  { id: 'ct085', ...cd(37,14,0),  cardId: 'card002', merchant: '아이허브',            inferredCategory: '쇼핑',  categoryNote: '건강식품·생활용품 혼재',     amount: -88000 },
  { id: 'ct086', ...cd(40,11,0),  cardId: 'card002', merchant: '스포티파이',          inferredCategory: '구독',  categoryNote: null,                         amount: -10900 },
  { id: 'ct087', ...cd(43,19,0),  cardId: 'card002', merchant: '쿠팡',                inferredCategory: '쇼핑',  categoryNote: '품목 불명 (온라인 종합몰)',   amount: -95000 },
  ...
  // 1월 — 신한카드
  { id: 'ct115', ...cd(53,10,0),  cardId: 'card002', merchant: '넷플릭스',            inferredCategory: '구독',  categoryNote: null,                         amount: -13900 },
  { id: 'ct116', ...cd(54,10,0),  cardId: 'card002', merchant: '유튜브 프리미엄',     inferredCategory: '구독',  categoryNote: null,                         amount: -14900 },
  { id: 'ct117', ...cd(57,18,0),  cardId: 'card002', merchant: '쿠팡이츠',            inferredCategory: '식비',  categoryNote: '음식 배달 (메뉴 불명)',       amount: -28000 },
  { id: 'ct118', ...cd(60,9,30),  cardId: 'card002', merchant: 'GS주유소',            inferredCategory: '교통',  categoryNote: null,                         amount: -60000 },
  { id: 'ct119', ...cd(63,14,0),  cardId: 'card002', merchant: '마켓컬리',            inferredCategory: '식품', categoryNote: '식품·생활용품 혼재',          amount: -72000 },
  { id: 'ct120', ...cd(66,11,0),  cardId: 'card002', merchant: '스포티파이',          inferredCategory: '구독',  categoryNote: null,                         amount: -10900 },
  { id: 'ct121', ...cd(69,19,30), cardId: 'card002', merchant: '쿠팡',                inferredCategory: '쇼핑',  categoryNote: '품목 불명 (온라인 종합몰)',   amount: -145000},
  ...
  // 12월 — 신한카드
  { id: 'ct145', ...cd(83,10,0),  cardId: 'card002', merchant: '넷플릭스',            inferredCategory: '구독',  categoryNote: null,                         amount: -13900 },
  { id: 'ct146', ...cd(84,10,0),  cardId: 'card002', merchant: '유튜브 프리미엄',     inferredCategory: '구독',  categoryNote: null,                         amount: -14900 },
  { id: 'ct147', ...cd(86,18,0),  cardId: 'card002', merchant: '아마존 해외직구',     inferredCategory: '쇼핑',  categoryNote: '품목 불명 (해외 직구)',       amount: -135000},
  { id: 'ct148', ...cd(89,9,30),  cardId: 'card002', merchant: 'GS주유소',            inferredCategory: '교통',  categoryNote: null,                         amount: -60000 },
  { id: 'ct149', ...cd(92,14,0),  cardId: 'card002', merchant: '스포티파이',          inferredCategory: '구독',  categoryNote: null,                         amount: -10900 },
  { id: 'ct150', ...cd(94,19,0),  cardId: 'card002', merchant: '쿠팡 연말대전',       inferredCategory: '쇼핑',  categoryNote: '품목 불명 (온라인 종합몰)',   amount: -198000},
]
